...
function seleccionarDatos3(form1, boton1, controlador1, div1, campo1)
{
  deshabilitarControl1(boton1);
  ajaxGet1(controlador1+'?valor=' + campo1, div1);
  ...
  */
  ...
  document.getElementById("contenedor2").addEventListener("click", function(event) {
    if (event.target.classList.contains("botonConsulta3")) {
        ...
        div2 = document.getElementById("formEdicion1");
        controlador3 = "Controllers/Consulta3Controller.php";

        seleccionarDatos3(formEdicion1,botonConsulta2,controlador3,div2, event.target.getAttribute('ide'));
